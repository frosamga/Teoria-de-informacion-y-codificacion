 ...
 *BMPHandler Class was originally written 
...
public class Visual extends JFrame{
    ...
    private JFrame resultFrame = new JFrame("GRAVE (GRAphics Viewer for Everywhere)");
    private Container contentPane = resultFrame.getContentPane();
 ...
 /*****
   ...
   public  void load(String file){
	...
	resultFrame.setSize(375,500);
        resultFrame.setTitle(file);
     ...
     *name, respectively.
     ****************************************************/
  public  ImageIcon openFile(String dir, String filename){
	...
	if(filename.endsWith(".gif")||filename.endsWith(".jpg")||filename.endsWith(".jpeg")){
	    ...
	    i = BMPHandler.loadbitmap(dir,filename);
	    oic = new ImageIcon(i);
	}
	else{
  ...
  public static ImageIcon openFile(String filename){
	...
	if(filename.endsWith(".gif")||filename.endsWith(".jpg")||filename.endsWith(".jpeg")){
	    ...
	    i = BMPHandler.loadbitmap("./",filename);
	    ic = new ImageIcon(i);
	}
	else{
	    System.out.println("Unable to open " + filename+".  File must end in bmp, gif, jpg or jpeg.");
     ...
     **************************************************/
  public void showNew(ImageIcon newIcon){
