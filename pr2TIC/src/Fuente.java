...
public class Fuente {
	...
	/**********
	 * Constructor de la clase. Inicialmente ordeno las probabilidades para
	 * estar en orden decreciente. Ojo puede ser un problema al codificar. Para
	 * este ejercicio no supone ningun problema
	 * 
	 * @param distribution
	...
	public double entropia() {
		...
		for (int i = 0; i < probabilidades.length; i++) {
			h -= this.probabilidades[i] * this.logBase2(probabilidades[i]);
		}
	...
	public double longitudMedia() {
		...
		if (parametersValid) {
			for (int i = 0; i < probabilidades.length; i++) {
				l += parametros[i] * probabilidades[i];
			}
		}
		return l;
	}
	...
	public int[] reglaDeShannonFano() {
		...
		for (int i = 0; i < probabilidades.length; i++) {
			parametros[i] = -(int) Math.floor(this.logBase2(probabilidades[i]));
		}
		// Tu codigo aqui
	...
	/************
	 * Calcula los codigos mediante arbol binario de practica 1 y los parametros
	 * de Shannon-Fano
	 * 
	 * @return
	...
	/*********
	 * Obtengo la longitud optima del codigo huffman. Si no esta calculado
	 * codigo optimo devuelve cero.
	 * 
	...
	/**********
	 * Ordena de forma descendente las probabilidades ToDo: Mejorar algoritmo
	 * 
	 * @param distribution
	 * @return
	 */
	...
	public static void main(String[] args) {
		...
		// Creo codigo con los parametros que calculamos con ShannonFano
		// mediante arbol binario
		...
		System.out.println("Ejercicio 5. Probabilidades: "
				+ Arrays.toString(probabilidadesEjemplo5));
